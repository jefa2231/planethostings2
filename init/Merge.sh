...
cd
git clone https://github.com/jefa2231/planethostings2.git
cd OpenUserBot
git remote set-url origin https://${GH_USERNAME}:${GH_PERSONAL_TOKEN}github.com/jefa2231/planethostings2.git
git fetch
